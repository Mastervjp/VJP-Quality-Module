...
@Component({
  selector: 'app-casting-periodic',
  templateUrl: './casting-periodic.component.html',
  styleUrls: ['./casting-periodic.component.css']
})
export class CastingPeriodicComponent implements OnInit {
