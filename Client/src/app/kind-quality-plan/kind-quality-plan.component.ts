...
@Component({
  selector: 'app-kind-quality-plan',
  templateUrl: './kind-quality-plan.component.html',
  styleUrls: ['./kind-quality-plan.component.css']
})
export class KindQualityPlanComponent implements OnInit {
